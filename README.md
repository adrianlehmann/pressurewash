# Spic & Span Pros Website

Marketing site for Spic & Span Pros, built with React and Vite.
...
This repo is set up for a **static** Cloudflare Pages deploy of the site in `artifacts/spic-and-span-pros`.
...
| **Build output directory** | `artifacts/spic-and-span-pros/dist/public` |
...
| Path | Purpose |
|------|---------|
| `artifacts/spic-and-span-pros` | **Production static site** (deploy this) |
